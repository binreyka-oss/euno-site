...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (sloganContainer && heroSection && window.matchMedia("(min-width: 769px)").matches) {
        // ИЗМЕНЕНИЕ: Увеличено количество слоганов
        const slogans = [
            ...
            "ты знаешь, как достигать цели", "ты знаешь, как вести за собой", "ты знаешь, как построить систему", "ты знаешь ценность команды",
            "ты знаешь, как мыслить глобально", "ты знаешь, как действовать локально", "ты знаешь, как измерить успех", "ты знаешь, как важны детали",
            "ты знаешь, что такое качество", "ты знаешь, как принимать решения", "ты знаешь, как вдохновлять команду", "ты знаешь, как слушать клиента",
            "ты знаешь, как превзойти ожидания", "ты знаешь, как управлять репутацией", "ты знаешь, как создавать будущее",
            "ты знаешь, что такое стратегия", "ты знаешь, как создавать эмоции", "ты знаешь, как быть настоящим"
        ];
        // ИЗМЕНЕНИЕ: Первая буква каждого слогана делается заглавной
        ...
        function createBubbles() {
            ...
            capitalizedSlogans.forEach(sloganText => {
                ...
                const bubble = {
                    ...
                    // ИЗМЕНЕНИЕ: Увеличена скорость движения
